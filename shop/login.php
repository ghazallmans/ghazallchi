...
">
                <div style="text-align: center;font-size: 30px"><p>ورود کاربر</p></div>
                <div style="display: flex;align-content: center;align-items: center">
                    <form action="login.php" method="post" class="form-group" style="margin: 0 auto;">
                        ...
                        <div style="text-align: center">
                            <input type="submit" value="ورود" class="btn btn-outline-success" name="login">
